...
impl CanSerialize<PublicKey> for PublicKeyCompressedSerializer {
    ...
    fn serialize(public_key: &PublicKey) -> Self::Output {
...
mod tests {
    ...
    fn test_serialize_point_uncompressed_sec_1() {
        let public_key = PublicKey::new(Secp256k1::generator());
        let expected_bytes = [
        ...
        let serialized_public_key = PublicKeyUncompressedSerializer::serialize(&public_key);
        assert_eq!(serialized_public_key, expected_bytes);
    }

    #[test]
    fn test_serialize_point_uncompressed_sec_2() {
        let public_key = PublicKey::from_u256(U256::from_u64(5000u64));
        let expected_bytes = [
    ...
    fn test_serialize_point_uncompressed_sec_3() {
        let public_key = PublicKey::from_u256(U256::from_u64(33466154331649568u64));
        let expected_bytes = [
    ...
    fn test_serialize_point_uncompressed_sec_4() {
        let public_key = PublicKey::from_u256(U256::from_u64(0xdeadbeef12345u64));
        let expected_bytes = [
    ...
    fn test_serialize_point_compressed_sec_1() {
        let public_key = PublicKey::from_u256(U256::from_u64(5001u64));
        let expected_bytes = [
    ...
    fn test_serialize_point_compressed_sec_2() {
        let public_key = PublicKey::from_u256(U256::from_u64(33549155665686099u64));
        let expected_bytes = [
    ...
    fn test_serialize_point_compressed_sec_3() {
        let public_key = PublicKey::from_u256(U256::from_u64(0xdeadbeef54321u64));
        let expected_bytes = [
